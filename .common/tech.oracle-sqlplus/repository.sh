...
case "${x_action}" in
	...
	(merge-inc)
		...
		echo '@"'$( EchoPathUnixToWin "${CommonsPath}/tech.oracle-sqlplus/merge_increments_to_repo.sql" )'"' >> "${TmpPath}/${gx_Env}.merge_increments_to_repo.${RndToken}.sql"
	...
	(get-list-to-exec)
		...
		echo '@"'$( EchoPathUnixToWin "${CommonsPath}/tech.oracle-sqlplus/retrieve_the_deployment_setup.sql" )'"' >> "${TmpPath}/${gx_Env}.retrieve_the_deployment_setup.${RndToken}.sql"
	...
	(create-run)
		...
		if [ "${x_deploy_action}" = "sync" ] ; then
			echo '@"'$( EchoPathUnixToWin "${CommonsPath}/tech.oracle-sqlplus/prepare_or_sync_deployment_run.sql" )'" sync-only' >> "${TmpPath}/${gx_Env}.set_up_deployment_run.${RndToken}.sql"
		else
			echo '@"'$( EchoPathUnixToWin "${CommonsPath}/tech.oracle-sqlplus/prepare_or_sync_deployment_run.sql" )'" normal' >> "${TmpPath}/${gx_Env}.set_up_deployment_run.${RndToken}.sql"
		fi
		echo '' >> "${TmpPath}/${gx_Env}.set_up_deployment_run.${RndToken}.sql"
