...
begin
    ...
    then
        ...
        insert into t_db_script_execution (id_db_script_execution, id_db_deployment, id_db_script, num_order, fip_start, fip_finish, num_return_code)
        values (seq_db_deployment.nextval, l_deployment_id, l_script_id, seq_db_deployment.nextval, l_script_start, systimestamp, 0);
    end if;
end;
/
